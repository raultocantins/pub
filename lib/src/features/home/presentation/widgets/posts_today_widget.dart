    ...
    return Padding(
      ...
      child: SizedBox(
        ...
        child: ListView.builder(
          ...
          itemCount: _controller?.todayPosts?.list?.length,
          itemBuilder: (BuildContext context, int i) {
            return GestureDetector(
              onTap: () => Navigator.of(context).pushNamed('/details-post',
                  arguments: {
                    'imageUrl': _controller?.todayPosts?.list?[i].imageUrl
                  }),
              child: SizedBox(
                width: 300,
                height: 100,
                    ...
                    children: [
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              fit: BoxFit.fill,
                              image: NetworkImage(
                                _controller?.todayPosts?.list?[i].imageUrl ??
                                    '',
                              ),
                            ),
                          ),
                      ...
                      SizedBox(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              _controller?.todayPosts?.list?[i].title ?? '',
                            ...
                            const Expanded(child: SizedBox()),
                            Text(
                              _controller?.todayPosts?.list?[i].pubName ?? '',
                              style: const TextStyle(
                                  color: Colors.white, fontSize: 12),
                            ),
                            Text(
                              _controller?.todayPosts?.list?[i].date
                                      .toString() ??
                                  '',
                              style: const TextStyle(
